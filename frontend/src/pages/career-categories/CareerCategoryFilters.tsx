...
import type { CareerCategoryFiltersProps } from '@/pages/career-categories/CareerCategories.types';

export function CareerCategoryFilters({
  filters,
  onFilterChange,
  onClearFilters,
  showFilters,
