...
import type { CareerFiltersProps } from '@/pages/careers/Careers.types';
            ...
            <div className="flex flex-col sm:flex-row sm:items-end gap-3">
              ...
              {hasActiveFilters && (
                <button
                  ...
                  type="button"
                  className="text-sm text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 flex items-center justify-center gap-1.5 transition-colors duration-200 px-3 sm:px-4 py-2.5 sm:py-2 rounded-md hover:bg-slate-100 dark:hover:bg-slate-700 touch-manipulation w-full sm:w-auto"
                >
